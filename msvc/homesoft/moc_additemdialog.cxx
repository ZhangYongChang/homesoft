...
#include "../../homesoft/additemdialog.h"
...
static const char qt_meta_stringdata_AddItemDialog[] = {
    "AddItemDialog\0"
};
...
const QMetaObjectExtraData AddItemDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject AddItemDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddItemDialog,
      qt_meta_data_AddItemDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AddItemDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddItemDialog))
